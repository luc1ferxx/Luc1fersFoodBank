...
VALUES ('Made with white meat chicken, our Chicken Fries are coated in a light crispy breading seasoned with savory spices and herbs.',
       ...
       ('Say hello to our Hershey Sundae Pie. One part crunchy chocolate crust and one part chocolate creme filling, garnished with a delicious topping and real chocolate chips.',
       ...
       ('Crispy chicken with mayo and fresh toppings on a toasted bun.',
       ...
       ('Two 1/4 lb savory flame-grilled beef patties topped with thick-cut smoked bacon, melted American cheese, ketchup, and creamy mayonnaise.',
       ...
       ('Rice, BBQ beef, and vegetables served in stoneware with an assortment of kimchi dishes.',
        ...
        'BBQ Beef and Vegetables in Stoneware', 20.27, 2),
       ('Tofu boiled with ham and cheese. Served with your choice of side and an assortment of kimchi dishes.',
        ...
        'Ham and Cheese Soft Tofu', 17.06, 2),
       ('Medium spicy.',
       ...
       ('A savory eggplant dish with pork, garlic, and cilantro.',
       ...
       ('Very spicy.',
        ...
        'Smashed Green Pepper, Chinese Eggplant and Preserved Egg', 11.99, 3),
       ('A simple greens dish with minced garlic.',
